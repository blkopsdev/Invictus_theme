...
<section id="content" role="main">
	...
	<header class="header">
		<div class="archive-blog-main-header-wrapper">
			...
			<h3 class="archive-blog-title"><?php printf( esc_html_e( 'Search Results for: ', 'invictus' ) ); ?><?php echo get_search_query(); ?>
</h3>
			<?php
			global $ins_opt;
...
<div class="search-nothing-found">
<h2 class=""><?php esc_html_e( 'Nothing Found', 'invictus' ); ?></h2>
<section class="entry-content">
<h5 style="margin-bottom:30px;"><?php esc_html_e( 'Sorry, nothing matched your search. Please try again.', 'invictus' ); ?></h5>
<?php get_search_form(); ?>
</div>
</section>
</div>
