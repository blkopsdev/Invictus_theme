...
global $css1, $portfolio_extra_class1, $port_load_more1, $port_on_hover1, $port_filter1, $port_cat1, $filter_layout1, $port_gap1;
...
<div class="inv-portfolio-element-main-wrapper clearfix <?php echo esc_attr($inv_port_wrapper_class); ?> clearfix <?php echo esc_attr($css1);?> <?php echo esc_attr($portfolio_extra_class1);?>" style="margin: 0 -<?php echo esc_html($port_gap1/2); ?>px;">

<?php if($port_filter1 == 'filter_on'){ 
$filter_class = 'inv-portfolio-filter-enabled';
?>
<div class="inv-portfolio-filter-button-holder">
<button class="inv-portfolio-filter-button-inner inv-portfolio-filter-button<?php echo esc_attr($filter_layout1); ?> active-filter-button" data-filter="*"><?php echo esc_html_e('show all','invictus'); ?></button>
<?php $port_cat2 = explode(",",$port_cat1);

foreach ($port_cat2 as $str) {
