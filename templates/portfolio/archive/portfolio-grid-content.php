...
<article style="padding: 0 <?php echo esc_html($port_gap1/2); ?>px; margin-bottom:<?php echo esc_html($port_gap1); ?>px;" class="<?php echo esc_attr($inv_port_column_classes); ?> inv-portfolio-hover-1 inv-portfolio-item-holder <?php echo esc_attr(implode(' ', $output)); ?> aos-init" data-aos-once="true" data-aos="<?php echo esc_html($appear_effects1); ?>" data-aos-delay="0">
...
<article style="padding: 0 <?php echo esc_html($port_gap1/2); ?>px; margin-bottom:<?php echo esc_html($port_gap1); ?>px;" class="<?php echo esc_attr($inv_port_column_classes); ?>  inv-portfolio-hover-2 inv-portfolio-item-holder <?php echo esc_attr(implode(' ', $output)); ?> aos-init" data-aos-once="true" data-aos="<?php echo esc_html($appear_effects1); ?>" data-aos-delay="0"> 
	<div class="inv-portfolio-hover-2-content">
		<div class="inv-portfolio-hover-2-detail">
		
		<div class="inv-portfolio-hover-2-thumb" style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url($post->ID,$image_size)); ?>');"></div>
...
<article style="padding: 0 <?php echo esc_html($port_gap1/2); ?>px; margin-bottom:<?php echo esc_html($port_gap1); ?>px;" class="<?php echo esc_attr($inv_port_column_classes); ?> inv-portfolio-hover-3 inv-portfolio-item-holder <?php echo esc_attr(implode(' ', $output)); ?> aos-init" data-aos-once="true" data-aos="<?php echo esc_html($appear_effects1); ?>" data-aos-delay="0">
...
<article style="padding: 0 <?php echo esc_html($port_gap1/2); ?>px; margin-bottom:<?php echo esc_html($port_gap1); ?>px;" class="<?php echo esc_attr($inv_port_column_classes); ?> inv-portfolio-hover-5 js-tilt inv-portfolio-item-holder <?php echo esc_attr(implode(' ', $output)); ?> aos-init" data-tilt-glare="true" data-tilt-maxglare=".6" data-tilt-speed="400" data-tilt-scale="1.04" data-tilt-maxtilt="50" data-tilt-perspective="2500" data-tilt-easing="cubic-bezier(.03,.98,.52,.99)" data-aos-once="true" data-aos="<?php echo esc_html($appear_effects1); ?>" data-aos-delay="0">
	...
	<div class="inv-portfolio-hover-5-overlay-wrapper">
		<div class="inv-portfolio-hover-5-overlay-inner">
			<div class="inv-portfolio-hover-5-entry-header">
				<span class="inv-portfolio-hover-5-cats"  style="font-size: <?php echo esc_html($category_size1);?>px; color: <?php echo esc_html($category_color1); ?>"><?php $terms = get_the_terms( $post->ID, 'portfolio_category' );
			if ( !empty( $terms ) ){
				foreach ( $terms as $term ) { ?>
...
<article style="padding: 0 <?php echo esc_html($port_gap1/2); ?>px; margin-bottom:<?php echo esc_html($port_gap1); ?>px;" class="<?php echo esc_attr($inv_port_column_classes); ?> inv-portfolio-hover-6 inv-portfolio-item-holder <?php echo esc_attr(implode(' ', $output)); ?> " data-aos-once="true" data-aos="<?php echo esc_html($appear_effects1); ?>" data-aos-delay="0">
