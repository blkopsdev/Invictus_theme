...
<h3 class="screen-reader-text" tabindex="0"><?php esc_html_e( 'Calendar Month Navigation', 'invictus' ) ?></h3>

<ul class="tribe-events-sub-nav events-list-main-nav events-month-main-nav ">
	<li class="tribe-events-nav-previous" aria-label="previous month link">
		<?php tribe_events_the_previous_month_link(); ?>
	</li>
	<!-- .tribe-events-nav-previous -->
	<li class="tribe-events-nav-next events-list-main-nav" aria-label="next month link">
