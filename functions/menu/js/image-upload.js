(function($) {
	...
	$(document).ready(function() {
		...
		$('.edit-menu-item-_insignia_mega_menu_enabled').each(function() {
			var $self = $(this);
			var $image_select = $self.parent().parent().siblings('.field-_insignia_mega_menu_image');
			var $image_position = $self.parent().parent().siblings('.field-_insignia_mega_menu_bg_position');
			var $image_repeat = $self.parent().parent().siblings('.field-_insignia_mega_menu_bg_repeat');
			var $columns_limit = $self.parent().parent().siblings('.field-_insignia_mega_menu_limit_columns');
	...
	$.runMegaMenu = function() {
		$("nav.mega-menu")
			...
			.on('megamenu:open', function(e, el) {
				...
				if($sub_nav.parents('#header-container').hasClass('insignia-enable-mega-menu')) {
...
/*
	...
	$window.scroll(function() {
		if (!scrollTimerId)
			$('#header-container nav.mega-menu').addClass('insignia-hide-overflow');

		clearTimeout(scrollTimerId);
		scrollTimerId = setTimeout(function(){
			$('#header-container nav.mega-menu').removeClass('insignia-hide-overflow');
...
*/
		var insigniaInitClickMenu = function(elem) {
		...
		/*insigniaInitClickMenu($('#side-area .onclick-nav-menu li.has-submenu > a'));*/
		insigniaInitClickMenu($('#header .onclick-nav-menu li.has-submenu > a'));
		insigniaInitClickMenu($('.widget.widget_nav_menu li.has-submenu > a'));
	});
})(jQuery);
