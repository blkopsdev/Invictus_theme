...
global $ins_opt;
	if ( class_exists('ReduxFrameworkPlugin') ) {
			$banner = $ins_opt['ins-opt-archive-banner']; 
		} else{
			$banner = '1';
		}
if($banner == 1){ ?>
...
?>
			...
			<h3 class="archive-blog-title"><?php echo esc_html_e('Latest Posts','invictus'); ?></h3>
			<?php
			global $ins_opt;
...
$post_id = $post->ID; //specify post id here
...
<a href="<?php echo esc_url(the_post_thumbnail_url('full'));?>" class="inv-popup-gallery" data-rel="<?php echo esc_html($slug);?>">
