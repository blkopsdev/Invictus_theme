<?php
/**
 * The template for displaying Left Sidebar blog
 *
	...
	<div class="inv-single-blog-title-inner">
		<div class="container">
			<div class="inv-single-blog-category-row">
				<div class="inv-single-blog-subtitle"><?php the_category(', '); ?></div>
			</div>
			
			<div class="inv-single-blog-title-row">
				<h1 class="inv-single-blog-title"><?php the_title(); ?></h1>
			</div>				
			
			<div class="inv-single-blog-meta-row">
				<div class="inv-single-blog-date inv-single-blog-meta-text">
					<time datetime="2016-11-07T16:24:47+00:00"><span class="inv-single-blog-before-meta"><?php echo esc_html_e('on ','invictus'); ?> </span><a href="<?php echo get_day_link( $archive_year, $archive_month, $archive_day); ?>"><?php the_date('F d, Y'); ?></a></time>
				</div>

				<div class="inv-single-blog-meta-text">
					<div class="inv-single-blog-author"><span class="inv-single-blog-before-meta"><?php echo esc_html_e('by ','invictus'); ?> </span><?php the_author_posts_link(); ?></div>
				</div>
...
$single_siderbar_class = 'col-md-9 col-lg-9 col-sm-12';
}else{
$single_siderbar_class = 'col-md-12 col-sm-12';
} ?>
...
<article class="<?php echo esc_attr($main_class); ?> <?php echo esc_attr($single_siderbar_class); ?>">
...
<?php
	...
	if($share_btn == '1'){ ?>
		...
		<h5><?php echo esc_html_e('Share this article','invictus');?></h5>
...
<span class="admin-top-text"><i><?php echo esc_html_e('Author','invictus'); ?></i></span>
<h2><?php the_author_posts_link(); ?></h2>
<p class="admin-sub-text"><?php echo get_the_author_meta('description'); ?></p>
...
<h3 class="inv-related-post-title"><?php echo esc_html_e('Related Posts','invictus'); ?></h3>
</div>
...
<div class="thumbnail-image entry-thumb-wrap" style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url($post->ID)); ?>');"><!--post-image--></div>
<?php } ?> 

<div class="inv-post-grid-one-content-wrap">
<div class="title entry-post-title inv-post-grid-one-title"><a href="<?php echo esc_url(get_permalink()); ?>" class="inv-title-h5"><?php the_title(); ?></a></div>
...
<?php if(!empty($prev) || !empty($next)){ ?>
	...
	<ul class="post-nav-lst clearfix">
		...
		<li class="col-md-2 text-center post-nav-grid-wrapper"><a href="<?php echo insignia_get_post_page_url(); ?>"><span class="ti-layout-grid2 post-nav-grid-icon"></span></a></li>
