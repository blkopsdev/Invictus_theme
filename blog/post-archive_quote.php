...
?>
	...
	<?php if (!empty($post_custom_quote_text)): ?>
			<div class="archive_quote-text" style="color:<?php echo esc_html($quote_author_clr); ?>"><?php echo wp_kses_post($post_custom_quote_text); ?></div>
	<?php endif; ?>

	<?php if (!empty($post_custom_author_name)): ?>
			<h5 style="color:<?php echo esc_html($quote_author_clr); ?>" class="archive_quote-author"><?php echo esc_html($post_custom_author_name); ?></h5>
	<?php endif; ?>
